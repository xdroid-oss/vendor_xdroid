...
$(TARGET_GENERATED_BOOTANIMATION): $(SOONG_ZIP)
	...
	$(hide) tar xfp vendor/xdroid/bootanimation/bootanimation.tar -C $(INTERMEDIATES)
	...
	prebuilts/tools-xdroid/${HOST_OS}-x86/bin/mogrify -resize $$RESOLUTION -colors 256 $(INTERMEDIATES)/*/*.png; \
	echo "$$IMAGESCALEWIDTH $$IMAGESCALEHEIGHT 60" > $(INTERMEDIATES)/desc.txt; \
	cat vendor/xdroid/bootanimation/desc.txt >> $(INTERMEDIATES)/desc.txt
